...
//			bJukeboxInUse = false;
		...
		case WM_CTLCOLORSTATIC: {
			if ((HWND)lParam == GetDlgItem(hDlg, IDC_LABELCOMMENT) || (HWND)lParam == GetDlgItem(hDlg, IDC_LABELROMNAME) || (HWND)lParam == GetDlgItem(hDlg, IDC_LABELROMINFO) || (HWND)lParam == GetDlgItem(hDlg, IDC_LABELSYSTEM) || (HWND)lParam == GetDlgItem(hDlg, IDC_LABELNOTES) || (HWND)lParam == GetDlgItem(hDlg, IDC_TEXTCOMMENT) || (HWND)lParam == GetDlgItem(hDlg, IDC_TEXTROMNAME) || (HWND)lParam == GetDlgItem(hDlg, IDC_TEXTROMINFO) || (HWND)lParam == GetDlgItem(hDlg, IDC_TEXTSYSTEM) || (HWND)lParam == GetDlgItem(hDlg, IDC_TEXTNOTES)) {
